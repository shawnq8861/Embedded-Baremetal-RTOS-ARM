 ...
 * DESCRIPTION:
 *
 *  LPC2478 standard definitions file
 * 
 * OS:
 *
 *  N/A
...
/******************************************************************************
 * BEGIN: Copied from LPC2378 for compatibility.
 ******************************************************************************/
...
#define P_SCB_REGS ((volatile LPC24XX_SCB *)LPC2478_SCB_BASE)
#define SET_PCLK(per,div) ((div) << (per))
#define GET_PCLK_SEL(PCLKSELn,per)     ( ( (PCLKSELn) >> (per) ) & 0x00000003 )

typedef volatile struct __attribute__ ((__packed__,__aligned__(4))) _LPC24XX_SCB {
                                /* Access Offset */
...
} LPC24XX_SCB, *P_LPC24XX_SCB;

// JSB #define P_SCB_REGS ((volatile LPC24XX_SCB *)LPC2478_SCB_BASE)
#define SET_PCLK(per,div) ((div) << (per))
#define GET_PCLK_SEL(PCLKSELn,per)     ( ( (PCLKSELn) >> (per) ) & 0x00000003 )
...
/* MAM */
// JSB #define MAMCR_OFF          0
#define MAMCR_PARTIAL      1
// JSB #define MAMCR_FULL         2
//#define MAMTIM_CYCLES      (((CCLK)+19999999)/20000000)
...
// JSB #define UART_BAUD(baud)    (U16)((PCLK/((baud)*16.0))+0.5)
...
/******************************************************************************
 * END: Copied from LPC2378 for compatibility.
 ******************************************************************************/
...
/* PIN SELECT - Chapter 8 of the LPC2478 User Manual */
...
// JSB #define MAMCR          0xE01FC000
// JSB #define MAMTIM         0xE01FC004
// JSB #define MEMMAP         0xE01FC040
// JSB #define PLLCON         0xE01FC080
// JSB #define PLLCFG         0xE01FC084
// JSB #define PLLSTAT        0xE01FC088
// JSB #define PLLFEED        0xE01FC08C

#define PCON           0xE01FC0C0
#define PCONP          0xE01FC0C4
	
// JSB #define SCS            0xE01FC1A0
// JSB #define CCLKCFG        0xE01FC104
#define USBCLKCFG      0xE01FC108
// JSB #define CLKSRCSEL      0xE01FC10C
// JSB #define PCLKSEL0       0xE01FC1A8
// JSB #define PCLKSEL1       0xE01FC1AC
...
// JSB #define BOOTLOADERMODE     0x0
// JSB #define USERFLASHMODE      0x1
// JSB #define USERRAMMODE        0x2
// JSB #define EXTERNALMEMORYMODE 0x3
// JSB #define MAMCR_OFF          0
// JSB #define MAMCR_PART         1
// JSB #define MAMCR_FULL         2
#define MAMTIM_CYCLES      (((CCLK)+19999999)/20000000)
...
#define SCS_MCIPWR         (1<<3)
#define SCS_OSCRANGE       (1<<4)
// JSB #define SCS_OSCEN          (1<<5)
// JSB #define SCS_OSCSTAT        (1<<6)
