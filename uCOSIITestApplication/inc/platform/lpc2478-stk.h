...
//#define USBC_LED_BIT        BIT(14)	// from LPC2378.h
#define USB_LINK_LED_BIT    BIT(13)	// from LPC2378.h

#define BUT1_BIT            BIT(19)
#define BUT2_BIT            BIT(21)

#define LCD_BL_BIT          BIT(26)	// from LPC2378.h
